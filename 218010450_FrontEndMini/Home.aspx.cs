...
namespace _218010450_FrontEndMini
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        protected void Book_Clicked(object sender, EventArgs e)
        {
            ...
            HttpResponseMessage response = client.GetAsync("https://localhost:44311/api/User?type=client&name=" + name.Value + "&surname=" + surname.Value + "&email=" + email.Value + "&password=" + password.Value + "&gender=" + gender.Value + "&number=" + number.Value + "&address=" + address.Value).Result;
