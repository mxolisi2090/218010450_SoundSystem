...
namespace _218010450_FrontEndMini
{
    public partial class AllOrders : System.Web.UI.Page
    {
        ...
        //    HttpResponseMessage feature = client.GetAsync("https://localhost:44311/api/Brand?userId=" + UserID + "&status=Active").Result;
        ...
        //                HttpResponseMessage countBooking = client.GetAsync("https://localhost:44311/api/Brand?orderId=" + QueryBookingId + "&status=Completed").Result;
        ...
        //        case "Waiting":
        //            {
        //                HttpResponseMessage countBooking = client.GetAsync("https://localhost:44311/api/Brand?orderId=" + QueryBookingId + "&status=Inprogress").Result;
        //                if (countBooking.IsSuccessStatusCode)
        //                {
        //                    var booking = countBooking.Content.ReadAsAsync<int>().Result;
        //                }
