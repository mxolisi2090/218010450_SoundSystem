...
namespace _218010450_FrontEndMini
{
    public partial class ProductList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HttpResponseMessage respond = client.GetAsync("https://localhost:44311/api/Components?brandName=" + BrandName).Result;
            ...
            foreach (var z in parts)
            {
                ...
                display += "<h4 class='shop-item-title font-alt'><a >"+z.Name+"</a></h4>";
                ...
                display += "<a class='btn btn-border-d btn-circle' id='customize' runat='server' href='ClientProduct.aspx?ItemID=" + z.PartId + "&Price="+z.Price+"&BrandName="+ BrandName + "'><i class='fa fa-android'></i> Add to Cart</a>";
                //Session["CompName"] = z.Name;
                display += "<a class='btn btn-border-d btn-circle'  href='C.aspx'><i class='fa fa-windows'></i> Customize</a></div>";
                display += "</div>";
